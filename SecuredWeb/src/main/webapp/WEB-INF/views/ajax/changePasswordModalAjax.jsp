       <!-- Modal Header -->
        ...
        <div class="modal-body">
        	<form action="#" method="POST" name="changePasswordForm">
                <div class="form-group col-lg-12">
                    <label class="col-lg-5 control-lable" for="userCurrentPassword">Current Password<span style="color:red;">*</span></label>
                    <div class="col-lg-7">
						<input type="password" name="userPassword" id="userCurrentPassword" class="form-control input-sm"/>
                    </div>
                </div>
                <div class="form-group col-lg-12">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="col-lg-7">
                        <input type="password" name="userConfirmPassword" id="userConfirmPassword" class="form-control input-sm"/>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-footer" id="ChangePasswordFooter">
        		<button id="ChangePasswordSubmit" type="button" class="btn btn-primary" onClick="changePassword()">Update</button> 
