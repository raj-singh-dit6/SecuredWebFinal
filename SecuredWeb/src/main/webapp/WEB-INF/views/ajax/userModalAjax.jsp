        ...
        <div class="modal-body">
        	<form action="#" method="POST" name="UserForm" id="UserForm">
                ...
                <div class="form-group col-md-12" id="userSsoIdDiv">
                    <label class="col-md-3 control-lable" for="userSsoId">User ID</label>
                    <div class="input-group col-md-7">
                           <input type="text" name="userSsoId" id="userSsoId" class="form-control input-sm" placeholder="User ID" />
                    </div>
                </div>
                <div class="form-group col-md-12" id="userPasswordDiv">
                ...
                <div class="form-group col-md-12" id="userConfirmPasswordDiv">
                    <label class="col-md-3 control-lable" for="userConfirmPassword">Confirm Password</label>
                    <div class="input-group col-md-7">
