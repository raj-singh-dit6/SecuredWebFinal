	        ...
	        <div id = "newUserModal"  class="modal-body">
	        	<form action="#" method="POST" name="addUserForm">
	                ...
	                <div class="form-group col-lg-12">
	                    ...
	                    <div class="col-lg-7">
							<input type="text" name="newSsoId" id="newSsoId" class="form-control input-sm" required/>
	                    </div>
	                </div>
	                <div class="form-group col-lg-12">
	                ...
	                <div class="form-group col-lg-12">
	                    ...
	                    <div class="col-lg-7">
	                        <input type="text" name="newEmail" id="newEmail" class="form-control input-sm" required/>
	                    </div>
	                </div>
	                <div class="form-group col-lg-12">
